...
plot(beta_v,ComputeR0(b, beta_h, eta_v, mu_v, beta_v, eta_h,mu_h,theta_h, gamma_h, alpha_h, sigma, rho_L, mu_L, K, f,N),'LineWidth',3.0, color='#80B3FF')
...
plot(beta_v,ComputeR0(b, beta_h, eta_v, mu_v, beta_v, eta_h,mu_h,theta_h, gamma_h, alpha_h, sigma, rho_L, mu_L, K, f,N),'LineWidth',3.0, color='#7E2F8E')
xlabel('\beta_v','Fontsize',20)
ylabel('R_0','Fontsize',20)
h=yline(1,'-','LineWidth',2.0)


legend ('$Low elevation$', '$High elevation$','interpreter','latex')
